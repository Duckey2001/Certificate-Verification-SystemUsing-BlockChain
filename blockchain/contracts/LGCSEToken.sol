...
contract LGCSEToken is ERC20, Ownable, ReentrancyGuard, Pausable {
    ...
    uint256 public constant MIN_CONTRIBUTION = 10 * 10**18;
    ...
    constructor() ERC20("LGCSE Project Token", "LGCSE") Ownable(msg.sender) {
