...
# Initialize FastAPI
app = FastAPI(title="CertiVert API", version="1.0.0")

# CORS - use CORS_ORIGINS env (comma-separated) or * for dev
# CORS - use specific origins for credentials
_cors_origins = ["http://localhost:3000", "http://localhost:3001", "http://localhost:3002", "http://localhost:3003", "http://localhost:3000/static", "http://127.0.0.1:33957", "http://127.0.0.1:3000", "http://127.0.0.1:39417"]  # Allow all ports, static, browser preview, and all variations
app.add_middleware(
    CORSMiddleware,
