...
class Blockchain {
    constructor() {
        ...
        this.validators = [
            { name: 'Ecol University', msp: 'EcolMSP', publicKey: 'ecol_pub_key', isIssuer: true },
            { name: 'Limkokwing University', msp: 'LimkokwingMSP', publicKey: 'limk_pub_key', isIssuer: false },
            { name: 'Botho University', msp: 'BothoMSP', publicKey: 'botho_pub_key', isIssuer: false },
            { name: 'NUL University', msp: 'NULMSP', publicKey: 'nul_pub_key', isIssuer: false }
        ];
    ...
    createDiplomaTransaction(certificateHash, studentId, studentName, examYear, issuer = 'Ecol') {
        const transaction = {
            type: 'ISSUE_DIPLOMA',
