    ...
    return new Promise((resolve, reject) => {
        try {
            ...
            QRCode.toFile(qrPath, certificateHash, async (err) => {
                ...
                doc.fontSize(8)
                   .text('© 2024 Ecol University | Blockchain Verified', { align: 'center' })
